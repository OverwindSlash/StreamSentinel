...
{
    public abstract class StreamSentinelWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StreamSentinelWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StreamSentinelWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StreamSentinelDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StreamSentinelDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StreamSentinelDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StreamSentinelDbContext, Task<T>> func)
        {
            T result;
