...
namespace StreamSentinel.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly StreamSentinelDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = StreamSentinelConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(StreamSentinelDbContext context)
        {
            _context = context;
        }
