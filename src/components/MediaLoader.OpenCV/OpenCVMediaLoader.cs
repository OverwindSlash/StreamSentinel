using OpenCvSharp;
using StreamSentinel.Components.Interfaces;
...
public class OpenCVMediaLoader : IStreamLoader, IDisposable
{
    private string _deviceId;
        private VideoCapture _capture;
        private MediaSpecs _streamSpecs;
        private readonly IConcurrentBoundedQueue<Frame> _frameBuffer;
        private bool _isInPlaying;
        private long _index;

        public OpenCVMediaLoader()
        : this("tempId", 30)
        { }

        public OpenCVMediaLoader(string deviceId, int bufferSize)
        {
            _deviceId = deviceId;
            _capture = new VideoCapture();
            _streamSpecs = new MediaSpecs(string.Empty, 0, 0, 0, 0);
        ...
        public MediaSpecs Specs => _streamSpecs;
        ...
        public void Open(string uri)
        {
            ...
            _streamSpecs = new MediaSpecs(uri, _capture.FrameWidth, _capture.FrameHeight, 
